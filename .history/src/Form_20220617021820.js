...
"How Tall are you?", "Are you FAT?"]
  ...
  return (
    <div>
        ...
        Start</button> : ""}
        <input  classplaceholder={maleQuestions[0]}/>
        <input  classplaceholder={maleQuestions[1]}/>
        <input  classplaceholder={maleQuestions[2]}/>
        <input  classplaceholder={maleQuestions[3]}/>
        <input class placeholder={maleQuestions[4]}/>
        </center>
    </div>
  )
}

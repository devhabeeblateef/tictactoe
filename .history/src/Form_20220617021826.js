...
"How Tall are you?", "Are you FAT?"]
  ...
  return (
    <div>
        ...
        Start</button> : ""}
        <input  className={classes.placeholder={maleQuestions[0]}/>
        <input  className={classes.placeholder={maleQuestions[1]}/>
        <input  className={classes.placeholder={maleQuestions[2]}/>
        <input  className={classes.placeholder={maleQuestions[3]}/>
        <input className={classes. placeholder={maleQuestions[4]}/>
        </center>
    </div>
  )
}
